...
export default async (req) => {
  ...
  const codigoInformado = (codigoDesconto || "").trim().toUpperCase();
  const codigoValido = codigoInformado === CODIGO_DESCONTO_HOSPEDE;
  const codigoTeste = codigoInformado === CODIGO_TESTE_R1;
